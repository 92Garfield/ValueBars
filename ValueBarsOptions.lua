        ...
        healthTab = {
            ...
            args = {
                ...
                hideOutOfCombat = {
                    ...
                    width = "full",
                    get = function(info)
                        return ValueBars.db.global.bars.health.hideOutOfCombat
                    end,
                    set = function(info, val)
        ...
        absorbDamageTab = {
            ...
            args = {
                ...
                hideOutOfCombat = {
                    ...
                    width = "full",
                    get = function(info)
                        return ValueBars.db.global.bars.absorbDamage.hideOutOfCombat
                    end,
                    set = function(info, val)
        ...
        absorbHealTab = {
            ...
            args = {
                ...
                hideOutOfCombat = {
                    ...
                    width = "full",
                    get = function(info)
                        return ValueBars.db.global.bars.absorbHeal.hideOutOfCombat
                    end,
                    set = function(info, val)
